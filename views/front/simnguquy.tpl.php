                    ...
                    <div class="full-row">
                        <div class="container">
                            ...
                            <div class="timkiem">                                                
                                            ...
                                            <div class="timkiem1">                                                                                       
                                            <a href="simlucquy.tpl.php"><button type="submit" class="btn1"><span style="font-size:16px; color: black;"><b>Sim lục quý </b></span></button></a>                                                                                         
                                            </div>
                                            <div class="timkiem1">                                                                                       
                    ...
                    <div class="tab-content mt-2" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                ...
                                <div class="col-md-3 col-lg-3">
                                    ...
                                    <form action="datphong.tpl.php" method="POST" enctype="multipart/form-data" class="form-sim">
